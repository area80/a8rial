package net.area80.a8real.view.starling
{
	...
	public class StarlingLine extends DisplayObject
	{
		...
		public function StarlingLine(radius:Number, numEdges:int = 6, color:uint = 0xffffff)
		{
			if (numEdges<3)
				throw new ArgumentError("Invalid number of edges");
